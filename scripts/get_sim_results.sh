...
for model in mlp; do
    ...
    [ -f $resdir/gold/tfidf.arrets.gold.correl ] || \
    ...
    [ -f $resdir/gold/tfidf.sommaires.gold.correl ] || \
    ...
    [ -f $resdir/gold/tfidf.titrages.gold.correl ] || \
    ...
    [ -f $resdir/gold/edsim.arrets.gold.correl ] || \
    ...
    [ -f $resdir/gold/edsim.sommaires.gold.correl ] || \
    ...
    [ -f $resdir/gold/edsim.titrages.gold.correl ] || \
    ...
    [ -s $resdir/gold/tfidf.titrages.gold__tfidf.sommaires.gold.correl ] || paste $tfidf_titrages_gold $tfidf_sommaires_gold | \
        OPENBLAS_NUM_THREADS=1 python $thisdir/correlation_sim.py -g $labels -m \
        $model -n "$model.tfidf.titrages.gold__tfidf.sommaires_gold" \
	> $resdir/gold/tfidf.titrages.gold__tfidf.sommaire_gold.correl
    
    [ -s $resdir/gold/edsim.titrages.gold__edsim.sommaires.gold.correl ] || paste $edsim_titrages_gold $edsim_sommaires_gold | \
        OPENBLAS_NUM_THREADS=1 python $thisdir/correlation_sim.py -g $labels -m \
        $model -n "$model.edsim.titrages.gold__edsim.sommaires_gold" \
        > $resdir/gold/edsim.titrages.gold__edsim.sommaires_gold.correl

    [ -s $resdir/gold/edsim.titrages.gold__tfidf.sommaires.gold.correl ] || paste $edsim_titrages_gold $tfidf_sommaires_gold | \
	OPENBLAS_NUM_THREADS=1 python $thisdir/correlation_sim.py -g $labels -m \
	$model -n "$model.edsim.titrages.gold__tfidf.sommaires_gold" \
        > $resdir/gold/edsim.titrages.gold__tfidf.sommaires_gold.correl

    [ -s $resdir/gold/tfidf.titrages.gold__edsim.sommaires.gold.correl ] || paste $tfidf_titrages_gold $edsim_sommaires_gold | \
	OPENBLAS_NUM_THREADS=1 python $thisdir/correlation_sim.py -g $labels -m \
	$model -n "$model.tfidf.titrages.gold__edsim.sommaires_gold" \
        > $resdir/gold/tfidf.titrages.gold__edsim.sommaires_gold.correl
	...
	for strategy in beam ; do 
		...
		for k in $(seq 20); do
		    ...
		    [ -s $predresdir/edsim.titrages.$k.correl ] || paste $edsim_titrages_pred.$strategy.pred.$calc.$k | \
			OPENBLAS_NUM_THREADS=1 python $thisdir/correlation_sim.py -g $labels -m \
		    ...
		    [ -s $predresdir/tfidf.titrages.$k.correl ] || paste $tfidf_titrages_pred.$strategy.pred.$calc.$k | \
			OPENBLAS_NUM_THREADS=1 python $thisdir/correlation_sim.py -g $labels -m \
		    ...
		    [ -s $goldpredresdir/edsim.titrages.1+$k.correl ] || paste $edsim_titrages_gold_pred.$strategy.gold+pred.$calc.1+$k | \
			OPENBLAS_NUM_THREADS=1 python $thisdir/correlation_sim.py -g $labels -m \
		    ...
		    [ -s $goldpredresdir/tfidf.titrages.1+$k.correl ] || paste $tfidf_titrages_gold_pred.$strategy.gold+pred.$calc.1+$k | \
			OPENBLAS_NUM_THREADS=1 python $thisdir/correlation_sim.py -g $labels -m \
		    ...
		    # predicted
                    [ -s $combodir/tfidf.titrages.gold__tfidf.titrages.pred.$k.correl ] || \
                    ...
                    [ -s $combodir/edsim.titrages.gold__edsim.titrages.pred.$k.correl ] || \
		    ...
		    # gold+predicted
                    [ -s $combodir/tfidf.titrages.gold__tfidf.titrages.gold+pred.1+$k.correl ] || \
                    ...
                    [ -s $combodir/edsim.titrages.gold__edsim.titrages.gold+pred.1+$k.correl ] || \
		    ...
		    # predicted
                    [ -s $predresdir/tfidf.sommaires.gold__tfidf.titrages.pred.$k.correl ] || \
                    ...
                    [ -s $combodir/edsim.sommaires.gold__edsim.titrages.pred.$k.correl ] || \
		    ...
		    # gold+predicted
                    [ -s $combodir/tfidf.sommaires.gold__tfidf.titrages.gold+pred.1+$k.correl ] || \
                    ...
                    [ -s $combodir/edsim.sommaires.gold__edsim.titrages.gold+pred.1+$k.correl ] || \
                        paste $edsim_titrages_gold $edsim_titrages_gold_pred.$strategy.gold+pred.$calc.1+$k | \
                        OPENBLAS_NUM_THREADS=1 python $thisdir/correlation_sim.py -g $labels -m \
		    ...
		    # predicted
                    [ -s $combodir/tfidf.titrages.gold__tfidf.sommaires.gold__tfidf.titrages.pred.$k.correl ] || \
                    ...
                    [ -s $combodir/edsim.titrages.gold__edsim.sommaires.gold__edsim.titrages.pred.$k.correl ] || \
		    ...
		    # gold+predicted
                    [ -s $combodir/tfidf.titrages.gold__tfidf.sommaires.gold__tfidf.titrages.gold+pred.1+$k.correl ] || \
                    ...
                    [ -s $combodir/edsim.titrages.gold__edsim.sommaires.gold__edsim.titrages.gold+pred.1+$k.correl ] || \
